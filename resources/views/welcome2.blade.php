    ...
    <script>
        ...
        schools.forEach(school => {
            ...
            const marker = L.marker([lat, lng], {
                    icon: school.bentuk_pendidikan === 'SD' ? schoolIconSMA : schoolIconSMK
                })
                .addTo(map)
                .bindTooltip(`
                    <div style="font-size: 13px;">
                        <table>
                            <tr>
                                <td style="vertical-align: top;"><b>${school.nama}</b></td>
                            </tr>
                            <tr>
            ...
            marker.schoolName = school.nama.toLowerCase();
            markers.push({
                marker,
                school
            });
