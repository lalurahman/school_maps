            ...
            foreach ($schools as $item) {
                ...
                if ($existingSchool) {
                    ...
                    School::create([
                        ...
                        'principal_name' => $item['nama_kepala_sekolah'] ?? '--',
                        'practice_facility' => $item['fasilitas_praktik'] ?? 'Fasilitas Praktik tidak tersedia',
                        'sports_facility' => $item['fasilitas_olahraga'] ?? 'Fasilitas Olahraga tidak tersedia',
                        'curriculum' => $item['kurikulum'] ?? 'Kurikulum tidak tersedia',
                        'extracurricular' => $item['ekstrakurikuler'] ?? 'Ekstrakurikuler tidak tersedia',
                        'achievements' => $item['prestasi'] ?? 'Prestasi tidak tersedia',
